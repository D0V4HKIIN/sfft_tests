...
FITS_REF = CDIR + '/res/ptf_m82_t_2k.fits'  # reference =? template?
FITS_SCI = CDIR + '/res/ptf_m82_s_2k.fits'  # science
FITS_DIFF = CDIR + '/out/diff.fits'         # difference
# sfft version: 1.4.0+
...
SATUR_KEY = 'SATURVAL'          # NOTE Keyword of Saturation in FITS header
